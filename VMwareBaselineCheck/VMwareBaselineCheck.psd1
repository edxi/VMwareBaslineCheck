#
# Module manifest for module 'PSGet_BaselineCheck'
#
# Generated by: edxi
#
...
# FunctionsToExport = '*'
FunctionsToExport = @('Compare-VesterOutput')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ProjectUri = 'https://github.com/edxi/VMwareBaselineCheck/'

        # A URL to an icon representing this module.
        IconUri = 'https://github.com/edxi/VMwareBaselineCheck/blob/master/images/PowerShell_icon.png'

        # ReleaseNotes of this module
        ReleaseNotes = 'https://github.com/edxi/VMwareBaslineCheck/releases'
